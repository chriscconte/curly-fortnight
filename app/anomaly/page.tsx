...
import { AnomalyPageClient } from "./AnomalyPageClient";
...
export default async function AnomalyPage() {
  ...
  const builtInAnomalies = detectAnomalies(records);
  ...
  return (
    <div className="p-8">
      ...
      <p className="mt-2 text-zinc-600 dark:text-zinc-400">
        ...
        level changes, and excessive hours. Define custom rules below.
      </p>
      <div className="mt-6">
        <AnomalyPageClient
          records={records}
          builtInAnomalies={builtInAnomalies}
        />
      </div>
    </div>
  );
